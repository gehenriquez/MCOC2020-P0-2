...
for i in range(Ncorridas):
    ...
    name = (f"inversa.scipy.True.longdouble{i}.txt")
...
for n in range(Ncorridas):
    arch_arreglo = np.loadtxt(f"inversa.scipy.True.longdouble{n}.txt")
...
plt.title("Rendimiento scipy.linalg.inv con overwrite_a=True y np.longdouble")
