...
for i in range(Ncorridas):
    ...
    name = (f"inversa.scipy.single{i}.txt")
...
for n in range(Ncorridas):
    arch_arreglo = np.loadtxt(f"inversa.scipy.single{n}.txt")
...
plt.title("Rendimiento scipy.linalg.inv con overwrite_a=False y np.single")
