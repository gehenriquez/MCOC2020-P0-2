...
for i in range(Ncorridas):
    ...
    name = (f"inversa.scipy.True.half{i}.txt")
...
for n in range(Ncorridas):
    arch_arreglo = np.loadtxt(f"inversa.scipy.True.half{n}.txt")
...
plt.title("Rendimiento scipy.linalg.inv con overwrite_a=True y np.half")
